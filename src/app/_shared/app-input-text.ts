...
/**
 * AppInputText is a shortcut of AppList.
 * 
 * INPUTS:
...
export class AppInputText implements FormValueControl<string> {

  // INPUTS
  label = input<string>()
  placeholder = input<string>()
  helperText = input<string[]>()
  clearInput = input<boolean>(true)
  inputmode = input<'decimal' | 'email' | 'none' | 'numeric' | 'search' | 'tel' | 'text' | 'url' | undefined>()
