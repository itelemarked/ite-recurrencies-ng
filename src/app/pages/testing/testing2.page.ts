...
@Component({
  ...
  template: `
    ...
    <ion-content [forceOverscroll]="false" class="ion-padding">
      ...
      <ion-input></ion-input>
      <input type="text" [formControl]="passwordCtl">
      <input type="text" [formControl]="confirmPasswordCtl">
...
export class TestingPage {
  ...
  passwordCtl = new FormControl('abcd')
  confirmPasswordCtl = new FormControl('abcde')

  constructor() {
    this.passwordCtl.addValidators(equals(this.confirmPasswordCtl)())
    this.confirmPasswordCtl.addValidators(equals(this.passwordCtl)())
  }
...
const equals = (ctl: AbstractControl) => () => (control: AbstractControl) => {
  console.log('equals fired')
  if(ctl.touched && control.touched && ctl.value.trim() !== control.value.trim()) return { 'missmatch': true }
  return null
} 
