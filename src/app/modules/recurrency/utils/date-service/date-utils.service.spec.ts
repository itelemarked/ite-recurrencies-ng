...
describe('date-utils.sercice.spec.ts', () => {
  ...
  describe('add()', () => {
    ...
    it('add 2 milliseconds', () => {
      const d1 = UTILS.add(d, PLUS2, 'milliseconds').toISOString()
      const result = '2026-06-01T12:00:00.002Z'
      expect(d1).toBe(result)
    })

    it('add 2 seconds', () => {
      const d1 = UTILS.add(d, PLUS2, 'seconds').toISOString()
      const result = '2026-06-01T12:00:02.000Z'
      expect(d1).toBe(result)
    })

    it('add 2 minutes', () => {
      const d1 = UTILS.add(d, PLUS2, 'minutes').toISOString()
      const result = '2026-06-01T12:02:00.000Z'
      expect(d1).toBe(result)
    })

    it('add 2 hours', () => {
      const d1 = UTILS.add(d, PLUS2, 'hours').toISOString()
      const result = '2026-06-01T14:00:00.000Z'
      expect(d1).toBe(result)
    })

    it('add 2 days', () => {
      const d1 = UTILS.add(d, PLUS2, 'days').toISOString()
      const result = '2026-06-03T12:00:00.000Z'
      expect(d1).toBe(result)
    })

    it('add 2 weeks', () => {
      const d1 = UTILS.add(d, PLUS2, 'weeks').toISOString()
      const result = '2026-06-15T12:00:00.000Z'
      expect(d1).toBe(result)
    })

    it('add 2 months', () => {
      const d1 = UTILS.add(d, PLUS2, 'months').toISOString()
      const result = '2026-08-01T12:00:00.000Z'
      expect(d1).toBe(result)
    })

    it('add 2 years', () => {
      const d1 = UTILS.add(d, PLUS2, 'years').toISOString()
    ...
    it('add -2 milliseconds', () => {
      const d1 = UTILS.add(d, MINUS2, 'milliseconds').toISOString()
      const result = '2026-06-01T11:59:59.998Z'
      expect(d1).toBe(result)
    })

    it('add -2 seconds', () => {
      const d1 = UTILS.add(d, MINUS2, 'seconds').toISOString()
      const result = '2026-06-01T11:59:58.000Z'
      expect(d1).toBe(result)
    })

    it('add -2 minutes', () => {
      const d1 = UTILS.add(d, MINUS2, 'minutes').toISOString()
      const result = '2026-06-01T11:58:00.000Z'
      expect(d1).toBe(result)
    })

    it('add -2 hours', () => {
      const d1 = UTILS.add(d, MINUS2, 'hours').toISOString()
      const result = '2026-06-01T10:00:00.000Z'
      expect(d1).toBe(result)
    })

    it('add -2 days', () => {
      const d1 = UTILS.add(d, MINUS2, 'days').toISOString()
      const result = '2026-05-30T12:00:00.000Z'
      expect(d1).toBe(result)
    })

    it('add -2 weeks', () => {
      const d1 = UTILS.add(d, MINUS2, 'weeks').toISOString()
      const result = '2026-05-18T12:00:00.000Z'
      expect(d1).toBe(result)
    })

    it('add -2 months', () => {
      const d1 = UTILS.add(d, MINUS2, 'months').toISOString()
      const result = '2026-04-01T12:00:00.000Z'
      expect(d1).toBe(result)
    })

    it('add -2 years', () => {
      const d1 = UTILS.add(d, MINUS2, 'years').toISOString()
  ...
  describe('endOf()', () => {
    ...
    it('end Of milliseconds', () => {
      const d1 = UTILS.endOf(d, 'milliseconds',ZURICH).toISOString()
      const result = '2026-06-01T12:12:12.123Z'
      expect(d1).toBe(result)
    })

    it('end Of seconds', () => {
      const d1 = UTILS.endOf(d, 'seconds', ZURICH).toISOString()
      const result = '2026-06-01T12:12:12.999Z'
      expect(d1).toBe(result)
    })

    it('end Of minutes', () => {
      const d1 = UTILS.endOf(d, 'minutes', ZURICH).toISOString()
      const result = '2026-06-01T12:12:59.999Z'
      expect(d1).toBe(result)
    })

    it('end Of hours', () => {
      const d1 = UTILS.endOf(d, 'hours', ZURICH).toISOString()
      const result = '2026-06-01T12:59:59.999Z'
      expect(d1).toBe(result)
    })

    it('end Of days', () => {
      const d1 = UTILS.endOf(d, 'days', ZURICH).toISOString()
      const result = '2026-06-01T21:59:59.999Z'
      expect(d1).toBe(result)
    })

    it('end Of weeks', () => {
      const d1 = UTILS.endOf(d, 'weeks', ZURICH).toISOString()
      const result = '2026-06-07T21:59:59.999Z'
      expect(d1).toBe(result)
    })

    it('end Of months', () => {
      const d1 = UTILS.endOf(d, 'months', ZURICH).toISOString()
      const result = '2026-06-30T21:59:59.999Z'
      expect(d1).toBe(result)
    })

    it('end Of years', () => {
      const d1 = UTILS.endOf(d, 'years', ZURICH).toISOString()
