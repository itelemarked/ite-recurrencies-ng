...
export const isTimezoneDate2 = (val: any): val is TimezoneDate2 => val instanceof TimezoneDate2
...
export class TimezoneDate2 implements TimezoneDateInterface {
// export class TimezoneDate2  {

  // STATE
  private state: TimezoneDateState

  static createByDate = (date: Date, timezone: Timezone, dateFormat: DateFormat) => new TimezoneDate2(date, timezone, dateFormat)
  ...
  static create = (dateString: DateString, timeString: TimeString, timezone: Timezone, dateFormat: DateFormat) => {
    ...
    return new TimezoneDate2(date, timezone, dateFormat)
  }
  ...
  diff = (unit: PeriodUnit, {
    // timezoneDate = TimezoneDate2.createByDate(new Date(), this.state.timezone, this.state.dateFormat), 
    timezoneDate,
    floored = true
  }: {
  ...
  update = ({
    ...
    return new TimezoneDate2(D.getDate(dateString, timeString, timezone), timezone, dateFormat)
  }
  ...
  add = (nb: PositiveInteger, unit: PeriodUnit, {
    ...
    return new TimezoneDate2(newDate, timezone, dateFormat)
  }
