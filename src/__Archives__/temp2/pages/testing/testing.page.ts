...
import { TestingInputComponent } from "./testing-input/testing-input.component";
import { TestingRecurrencyListItemComponent } from "./testing-recurrency-list-item/testing-recurrency-list-item.component";
...
@Component({
  ...
  imports: [
    ...
    TestingRecurrencyListItemComponent
],
  template: `
    <ion-header>
      <ion-toolbar>
    ...
    <ion-content [forceOverscroll]="false">
      ...
      <!-- <testing-input/> -->
       <app-testing-recurrency-list-item/>
...
// import { AppInputComponent } from './testing-input/app-input.component';
...
//     console.log('onUpdateEmailErrorMessagesWhenTouched')
//     const touched = this.emailCtl.touched
//     const errors = this._emailControlValidator(this.emailCtl.value)
//     const errorMessages = errors === null ? [] : Object.values(errors)
//     this.emailErrorMessagesWhenTouched = touched ? errorMessages : []
//   }
...
//   private _emailControlValidator(emailInputValue: string | null): ControlError | null {
//     if(emailInputValue === null) return {'null': '"Null" value not allowed...'}
